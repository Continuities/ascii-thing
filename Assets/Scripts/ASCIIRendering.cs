...
namespace UnityStandardAssets.ImageEffects
{
    ...
    public class ASCIIRendering : MonoBehaviour
    {
        ...
        public Color monochromaticColour = Color.red;
        [Range(0, 1)]
        public float dimming = 1f;
        public Texture2D ContrastCurve;
        ...
        private void OnRenderImage(RenderTexture source, RenderTexture destination)
        {
            ...
            m_ASCII.SetColor("_monoColour", monochromaticColour);
            m_ASCII.SetFloat("_dimming", dimming);
            m_ASCII.SetTexture("_contrastCurve", ContrastCurve);
